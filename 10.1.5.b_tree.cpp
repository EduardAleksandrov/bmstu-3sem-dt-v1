...
public:
    ...
    struct node* llrot(struct node *n) // правый поворот
    {
        struct node *p;
        struct node *tp;
        p = n;
    ...
    struct node* rrrot(struct node *n) // левый поворот
    {
        struct node *p;
        struct node *tp;
        p = n;
    ...
    struct node* rlrot(struct node *n) // большой левый
    {
        struct node *p;
        struct node *tp;
        struct node *tp2;
    ...
    struct node* lrrot(struct node *n) // большой правый
    {
        struct node *p;
        struct node *tp;
        struct node *tp2;
    ...
    void print(struct node *v) // обход в ширину
    { 
        queue <struct node *> q;
        struct node *cur;
        q.push(v);
    ...
    while(true)
    {
        ...
        switch (c)
        {
            ...
            case 3: 
                ...
                if(s != NULL) cout << s->data << ", высота: " << hh << "\n";
